...
void Simulation::project_longrange_constraints()
{
	...
	// grid ������� �ڽ��� �����ϴ� cell�� ������ cell�� �ִ� ��ƼŬ�鿡 ���� constraint
	for (int i = 0; i < num_particles; i++)
	{
...
void Simulation::do_time_step()
{
	...
	for (int i = 0; i < num_particles; i++)
	{
		...
		particles[i]->V.x = dx / time_step;  // �ӵ� ���� �ܰ迡�� time_step �����ֱ� ������ ���� ������
		particles[i]->V.z = dz / time_step;

		if (FTL)
		{
			// + s_damping * (-d_ / time_step)
			// d_�� ���� Particle�� conrrection
		...
		if (STEERING)
		{
			// V���� �̹� time_step�� / ���� ���ֱ� ������ ���� ����� ŭ -> desired_V�� ����� ũ�� ������ֱ� ����
		...
		{
			// viscosity 4.3
			float h = 7.0f; //15.0f;  // ���ɷ��� �ۿ��ϴ� �Ÿ�
			float c = 217.0f;// *3.0f;  // ���ɷ��� ũ��
			float weight = 0;
